(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.katex = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";
 ...
 */
var renderToCanvas = function renderToCanvas(expression, canvas, x, y, options) {
    var settings = new Settings(options);
 ...
 */
var canvasBox = function canvasBox(expression, canvas, options) {
    var settings = new Settings(options);
...
},{"./src/ParseError":9,"./src/Settings":11,"./src/buildHTML":14,"./src/buildTree":16,"./src/canvasRenderer":17,"./src/parseTree":26,"./src/utils":29}],2:[function(require,module,exports){
...
},{"./ParseError":9,"match-at":5}],7:[function(require,module,exports){
"use strict";
...
},{"./Lexer":6}],8:[function(require,module,exports){
"use strict";
...
},{"./MacroExpander":7,"./ParseError":9,"./environments":20,"./functions":23,"./parseData":25,"./symbols":27,"./unicodeRegexes":28,"./utils":29}],11:[function(require,module,exports){
"use strict";
...
},{"./Options":8,"./Style":12}],12:[function(require,module,exports){
"use strict";
...
for (var _i = 0; _i < 3; _i++) {
    metrics[_i].emPerEx = sigmas.xHeight[_i] / sigmas.quad[_i];
}
...
var styles = [new Style(D, 0, 1.0, false), new Style(Dc, 0, 1.0, true), new Style(T, 1, 1.0, false), new Style(Tc, 1, 1.0, true), new Style(S, 2, 0.7, false), new Style(Sc, 2, 0.7, true), new Style(SS, 3, 0.5, false), new Style(SSc, 3, 0.5, true)];
...
},{"./fontMetrics.js":21}],13:[function(require,module,exports){
"use strict";
...
var mathit = function mathit(value, mode, options, classes) {
    ...
    // glyphs for \imath and \jmath do not exist in LMath-Italic so we
...
var fontMap = {
    ...
    // and LMath-Italic.  This is handled by a special case in makeOrd which ends
    // up calling mathit.
...
},{"./domTree":19,"./fontMetrics":21,"./symbols":27,"./utils":29}],14:[function(require,module,exports){
"use strict";
...
var buildExpression = function buildExpression(expression, options, isRealGroup) {
    ...
    for (var _i = 0; _i < groups.length; _i++) {
        if (isSpace(groups[_i])) {
            spaces = spaces || [];
            spaces.push(groups[_i]);
            groups.splice(_i, 1);
            _i--;
        } else if (spaces) {
            if (groups[_i] instanceof domTree.symbolNode) {
                groups[_i] = makeSpan([].concat(groups[_i].classes), [groups[_i]]);
            }
            buildCommon.prependChildren(groups[_i], spaces);
            spaces = null;
        }
    }
    if (spaces) {
...
var calculateSize = function calculateSize(sizeValue, style) {
...
groupTypes.underline = function (group, options) {
    ...
    // Generate the vlist, with the appropriate kerns
    var vlist = buildCommon.makeVList([{ type: "kern", size: ruleWidth }, { type: "elem", elem: line }, { type: "kern", size: 3 * ruleWidth }, { type: "elem", elem: innerGroup }], "top", innerGroup.height, options);
...
groupTypes.sqrt = function (group, options) {
    ...
    if (!group.value.index) {
        ...
        var rootWrap = makeSpan([style.reset(), Style.SCRIPTSCRIPT.cls()], [root], newOptions);
...
groupTypes.sizing = function (group, options) {
    ...
    var style = options.style;
    var fontSize = buildCommon.sizingMultiplier[group.value.size] * style.sizeMultiplier;
...
groupTypes.leftright = function (group, options) {
    ...
    if (hadMiddle) {
        for (var _i3 = 1; _i3 < inner.length; _i3++) {
            if (inner[_i3].isMiddle) {
                // Apply the options that were active when \middle was called
                inner[_i3] = delimiter.leftRightDelim(inner[_i3].isMiddle.value, innerHeight, innerDepth, inner[_i3].isMiddle.options, group.mode, []);
            }
        }
    }
...
groupTypes.accent = function (group, options) {
    ...
    // Build the accent
    var accent = buildCommon.makeSymbol(group.value.accent, "Main-Regular", "math", options);
...
},{"./ParseError":9,"./Style":12,"./buildCommon":13,"./delimiter":18,"./domTree":19,"./fontMetrics":21,"./utils":29,"babel-runtime/core-js/json/stringify":2}],15:[function(require,module,exports){
"use strict";
...
},{"./ParseError":9,"./buildCommon":13,"./fontMetrics":21,"./mathMLTree":24,"./symbols":27,"./utils":29}],16:[function(require,module,exports){
"use strict";
...
},{"./Settings":11,"./buildCommon":13,"./buildHTML":14,"./buildMathML":15}],17:[function(require,module,exports){
"use strict";

var align = { left: 0, center: 0.5, right: 1 };

var sizes = [null, 0.5, 0.7, 0.8, 0.9, 1.0, 1.2, 1.44, 1.73, 2.07, 2.49];
    ...
    this.renderAt = function (x, y) {
        ...
        backupCanvasState(canvas, function (ctxt) {
            ...
            for (var i = 0; i < atoms.length; ++i) {
                var atom = atoms[i];
                ctxt.fillStyle = atom.color === null ? initialColor : atom.color;
                if (atom.text) {
                    ctxt.font = atom.font;
                    ctxt.fillText(atom.text, atom.x + x, atom.y + y);
                } else if (atom.width || atom.height) {
                    ctxt.fillRect(atom.x + x, atom.y + y - atom.height, atom.width, atom.height);
                }
            }
        });
    };
...
function prepare(dom, canvas, options) {
    return backupCanvasState(canvas, function (ctxt) {
        ...
        var box = new PreparedBox(ctxt, renderer.outList, renderer.fontsUsed, xshift);
...
var makeLeftRightDelim = function makeLeftRightDelim(delim, height, depth, options, mode, classes) {
    ...
    //   LMath.floor(655360 * maxDistFromAxis / 500) *
...
},{"./ParseError":9,"./Style":12,"./buildCommon":13,"./fontMetrics":21,"./symbols":27,"./utils":29}],19:[function(require,module,exports){
"use strict";
...
},{"./unicodeRegexes":28,"./utils":29}],20:[function(require,module,exports){
"use strict";
...
},{"./ParseError":9,"./Style":12,"./parseData":25}],21:[function(require,module,exports){
"use strict";
...
},{"./Style":12,"./fontMetricsData":22,"./unicodeRegexes":28}],22:[function(require,module,exports){
"use strict";
...
// LMath class commands except \mathop
...
},{"./ParseError":9,"./parseData":25,"./utils":29}],24:[function(require,module,exports){
"use strict";
...
},{"./Parser":10}],27:[function(require,module,exports){
"use strict";
 ...
 *
 * @param {*} text LMath value to escape.
